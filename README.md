...
- Драматическая последовательность проверки.
- Анимация рассеивания «облака».
- Отдельные сценарии НЕТ / ПЯТНИЦА.
- Конфетти, фейерверки, вибрация и синтезированный праздничный звук.
- Кнопка отключения звука.
- Никаких аудиофайлов или дополнительных библиотек.
